...
import 'package:digital_menu_test/AddOrder/AddOrderProductDetails.dart';
...
class AddOrderMenu extends StatefulWidget {
  @override
  _AddOrderMenuState createState() => _AddOrderMenuState();
}

class _AddOrderMenuState extends State<AddOrderMenu> {
  List categories = [];
  List Submenu = [];
...
class AddOrderSingle_prod extends StatelessWidget {
  final prod_name;
  final prod_pricture;
  final prod_id;
  final prod_price;
      ...
      child: InkWell(
        onTap: () => Navigator.of(context).push(new MaterialPageRoute(
          //here we are passing the values of the product to the product details page
            builder: (context) => new AddOrderProductDetails(
