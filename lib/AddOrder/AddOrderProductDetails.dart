...
class AddOrderProductDetails extends StatefulWidget {
  ...
  @override
  _AddOrderProductDetailsState createState() => _AddOrderProductDetailsState();
}

class _AddOrderProductDetailsState extends State<AddOrderProductDetails> {
              ...
              Expanded(
                child: MaterialButton(
                    onPressed: () {
                      ...
                      if(orderType=='eat in') {
                        AddOrdereatin_items.add(jsonOrders);
                        print(AddOrdereatin_items);
                      }
                      if(orderType=='take out') {
                        AddOrdertakeout_items.add(jsonOrders);
                        print(AddOrdertakeout_items);
                      }
                      setState(() {
